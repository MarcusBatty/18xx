      ...
      module Map
        ...
        HEXES = {
          ...
          red: {
              ...
              ['B15'] => 'offboard=revenue:0,groups:STL;path=a:4,b:5;border=edge:3,type:water;border=edge:4,type:water,cost:20;border=edge:5',
              ...
              ['C16'] => 'offboard=revenue:0,groups:STL;path=a:2,b:1;path=a:3,b:1;path=a:4,b:1;path=a:5,b:1;border=edge:2;border=edge:3,type:water,cost:20;border=edge:4,type:water,cost:20;border=edge:5,type:water,cost:20;border=edge:1',
