      ...
      module Map
        ...
        HEXES = {
          ...
          white: {
            ...
            %w[D9 E14 F13 H11] => 'town=revenue:0,groups:mine;icon=image:18_il/mine,sticky:1',
              ...
              ['E20'] => 'path=a:4,b:0,track:future;icon=image:18_il/ic_cube,sticky:1',
              ...
              ['G8'] => 'path=a:4,b:0,track:future;icon=image:18_il/ic_cube,sticky:1',
              ['G12'] => 'path=a:3,b:0,track:future;icon=image:18_il/ic_cube,sticky:1',
              ['G14'] => 'path=a:1,b:3,track:future;upgrade=cost:20,terrain:water;icon=image:18_il/ic_cube,sticky:1',
              ['G10'] => 'label=C;city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;icon=image:18_il/ic_cube,sticky:1',
              ...
              ['H7'] => 'label=K;city=revenue:0;path=a:1,b:_0,track:future;path=a:3,b:_0,track:future;icon=image:18_il/ic_cube,sticky:1',
