...
module Engine
 ...
 #         'B1' => 'St. Paul Harbor',
        ...
        HEXES = {
          ...
          white: {
            %w[C10 C12 D7 D11 E4 E10 E18 F7 G18 H9 H13] => '',
            ...
            %w[D9 E14 E16 F13 H11] => 'town=revenue:0,groups:mine;icon=image:18_il/mine,sticky:1',
              ...
              ['C2'] => 'label=G;town=revenue:0,groups:Galena;upgrade=cost:60,terrain:mountain;icon=image:18_il/mine,sticky:1;border=edge:1,type:water,cost:20',
              ...
              ['D17'] => 'town=revenue:0,groups:mine;border=edge:1,type:water;border=edge:2,type:water,cost:20;icon=image:18_il/mine,sticky:1',
              ['D19'] => 'border=edge:1,type:water;border=edge:2,type:water;border=edge:0', 
              ...
              ['F17'] => 'label=C;city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;icon=image:18_il/ic_cube,sticky:1,loc:1.5;upgrade=cost:20,terrain:water',
              ...
              ['G10'] => 'label=C;city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;icon=image:18_il/ic_cube,sticky:1,loc:1.5',
              ['G20'] => 'border=edge:5,type:water,cost:20',
              ['G22'] => 'town=revenue:0,groups:mine;icon=image:18_il/mine,sticky:1;border=edge:5,type:water;border=edge:4,type:water;border=edge:0,type:water,cost:20;border=edge:1,type:water,cost:20',
              ['H7'] => 'label=K;city=revenue:0;path=a:1,b:_0,track:future;path=a:3,b:_0,track:future;icon=image:18_il/ic_cube,sticky:1,loc:1.5',
          ...
          gray: {
              ...
              ['D1'] => 'path=a:1,b:5',
              ['D21'] => 'junction;path=a:0,b:_0;path=a:4,b:_0;path=a:5,b:_0;border=edge:3,type:water;border=edge:4,type:water,cost:20;border=edge:5,type:water,cost:20',
              ['F1'] => 'path=a:1,b:0',
              ['H15'] => 'path=a:1,b:3;border=edge:4,type:water;border=edge:5,type:water',
          ...
          red: {
              ['A10'] => 'label=W;offboard=revenue:yellow_20|brown_0,groups:West;path=a:4,b:_0;path=a:5,b:_0;border=edge:4,type:water,cost:20;border=edge:5,type:water,cost:20',
              ...
              ['B17'] => 'offboard=revenue:yellow_60|brown_100,groups:STL;path=a:4,b:_0;border=edge:3;border=edge:4;border=edge:5',
