      ...
      module Map
        ...
        HEXES = {
          ...
          white: {
            ...
            %w[D9 E14 F13 H11] => 'town=revenue:0;icon=image:18_il/mine',
              ...
              ['C2'] => 'label=G;town=revenue:0;upgrade=cost:60,terrain:mountain;icon=image:18_il/mine;border=edge:1,type:water,cost:20',
              ...
              ['E6'] => 'town=revenue:0;upgrade=cost:20,terrain:water;icon=image:18_il/mine',
              ['E12'] => 'label=S;city=revenue:20;path=a:1,b:_0',
              ['E20'] => 'path=a:4,b:0,track:future;icon=image:18_il/ic_cube',
              ['E22'] => 'label=C;city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;border=edge:0,type:water,cost:20;border=edge:5,type:water;icon=image:18_il/ic_cube',
              ['F5'] => 'town=revenue:0;upgrade=cost:20,terrain:water;icon=image:18_il/mine',
              ['F15'] => 'path=a:4,b:0,track:future;icon=image:18_il/ic_cube',
              ['F17'] => 'city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;icon=image:18_il/ic_cube;upgrade=cost:20,terrain:water',
              ['F19'] => 'path=a:1,b:3,track:future;upgrade=cost:20,terrain:water;icon=image:18_il/ic_cube',
              ['F21'] => 'town=revenue:0;border=edge:0,type:water,cost:20;icon=image:18_il/mine',           
              ['G6'] => 'city=revenue:0;upgrade=cost:20,terrain:water',
              ['G8'] => 'path=a:4,b:0,track:future;icon=image:18_il/ic_cube',
              ['G12'] => 'path=a:3,b:0,track:future;icon=image:18_il/ic_cube',
              ['G14'] => 'path=a:1,b:3,track:future;upgrade=cost:20,terrain:water;icon=image:18_il/ic_cube',
              ['G10'] => 'label=C;city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;icon=image:18_il/ic_cube',
              ['G20'] => 'border=edge:5,type:water,cost:20',
              ['G22'] => 'town=revenue:0;icon=image:18_il/mine;border=edge:5,type:water;border=edge:4,type:water;border=edge:0,type:water,cost:20;border=edge:1,type:water,cost:20',
              ['H7'] => 'label=K;city=revenue:0;path=a:1,b:_0,track:future;path=a:3,b:_0,track:future;icon=image:18_il/ic_cube',
          ...
          gray: {
              ['B7'] => 'offboard=revenue:0;path=a:4,b:_0;border=edge:0,type:water;border=edge:4,type:water;border=edge:5,type:water',
              ['D1'] => 'path=a:1,b:5',
          ...
          red: {
              ...
              ['B15'] => 'offboard=revenue:0,groups:STL;path=a:4,b:5;border=edge:0;border=edge:3,type:water;border=edge:4,type:water,cost:20;border=edge:5',
              ...
              ['C16'] => 'offboard=revenue:0,groups:STL;path=a:2,b:1;path=a:3,b:1;path=a:4,b:1;path=a:5,b:1;border=edge:0;border=edge:1;border=edge:2;border=edge:3,type:water,cost:20;border=edge:4,type:water,cost:20;border=edge:5,type:water,cost:20',
              ['C18'] => 'offboard=revenue:0,groups:STL;city=revenue:0,slots:4;border=edge:2;border=edge:3;border=edge:4,type:water;border=edge:5,type:water',
