        ...
        HEXES = {
          ...
          white: {
            ...
            %w[D9 E14 F13 H11] => 'town=revenue:0;icon=image:18_co/mine',
              ...
              ['C2'] => 'label=G;town=revenue:0;upgrade=cost:60,type:mountain;icon=image:18_co/mine;border=edge:1,type:water,cost:20',
              ...
              ['E6'] => 'town=revenue:0;upgrade=cost:20,type:water;icon=image:18_co/mine',
              ...
              ['F5'] => 'town=revenue:0;upgrade=cost:20,type:water;icon=image:18_co/mine',
              ['F15'] => 'path=a:4,b:0,track:future',
              ['F17'] => 'city=revenue:0;path=a:3,b:_0,track:future;path=a:0,b:_0,track:future;upgrade=cost:20,type:water',
              ['F19'] => 'path=a:1,b:3,track:future;upgrade=cost:20,type:water',
              ['F21'] => 'town=revenue:0;border=edge:0,type:water,cost:20;icon=image:18_co/mine',           
              ['G6'] => 'city=revenue:0;upgrade=cost:20,type:water',
              ['G8'] => 'path=a:4,b:0,track:future',
              ['G12'] => 'path=a:3,b:0,track:future',
              ['G14'] => 'path=a:1,b:3,track:future;upgrade=cost:20,type:water',
          ...
          yellow: {
              ...
              ['H5'] => 'path=a:3,b:0',
              ['E8'] => 'label=P;city=revenue:20;path=a:3,b:_0;upgrade=cost:20,type:water',
          },
